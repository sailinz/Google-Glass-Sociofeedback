...
static JNINativeMethod gMethods[] = {
    {"DoFFT", "([DI)V", (void *)Java_com_example_indrihartanto_glasssociofeedback_DoFFT},
};
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jniRegisterNativeMethods(env, "com/example/indrihartanto/glasssociofeedback/PitchDetector", gMethods, 1);
    return JNI_VERSION_1_4;
}

void Java_com_example_indrihartanto_glasssociofeedback_DoFFT(
            JNIEnv* env,
	        jobject thiz,
            jdoubleArray data,
            jint size) {
